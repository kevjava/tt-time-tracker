...
/**
 * Switch to a new session based on an existing session's metadata
 */
function switchFromSessionTemplate(db: TimeTrackerDB, sessionId: number, options: SwitchOptions): void {
  ...
  // Step 2: Determine the actual start time
