...
# start command
complete -c tt -f -n '__fish_seen_subcommand_from start' -s p -l project -d 'Project name' -a '(__tt_recent_projects)'
complete -c tt -f -n '__fish_seen_subcommand_from start' -s t -l tags -d 'Tags (comma-separated)' -a '(__tt_recent_tags)'
complete -c tt -f -n '__fish_seen_subcommand_from start' -s e -l estimate -d 'Estimated duration' -a '15m 30m 1h 1h30m 2h 3h 4h'
complete -c tt -f -n '__fish_seen_subcommand_from start' -l at -d 'Start time' -a '-15m -30m -1h'
complete -c tt -f -n '__fish_seen_subcommand_from start' -l help -d 'Show help'
